...
But you won't have to install any of the packages needed for exercises and assignments in this course because I've already done that for you.  Once a package is installed, you can load it into your current environment using `library`:
...
Make a new R Markdown document now with `File -> New File -> R Markdown`.  Take a moment to look at the example formatting.
